...
local function UpdateBlips()
    ...
    for k, v in pairs(players) do
        if (v.PlayerData.job.name == "sheriff" or v.PlayerData.job.name == "ambulance" or v.PlayerData.job.name == "police" or v.PlayerData.job.name == "sasp") and v.PlayerData.job.onduty then
...
RegisterNetEvent('sheriff:server:EscortPlayer', function(playerId)
    ...
    if EscortPlayer then
        if (Player.PlayerData.job.name == "sheriff" or Player.PlayerData.job.name == "ambulance" or Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "sasp") or (EscortPlayer.PlayerData.metadata["ishandcuffed"] or EscortPlayer.PlayerData.metadata["isdead"] or EscortPlayer.PlayerData.metadata["inlaststand"]) then
